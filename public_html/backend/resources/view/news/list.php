          ...
          <thead>
            <tr>
              ...
              <th width="10%" class="center"><?=$this->lang->label->images?></th>
							...
							<th width="36%"><?=$this->lang->label->title?></th>
          ...
          <tbody>
              ...
              <tr>
                ...
                <td class="center">
									<?php if(!empty($value['thumbnail'])){ ?>
										<a href="<?=$this->mediaURL('news_thumbnail').$value['thumbnail']?>" data-lity>
										 <img src="<?=$this->mediaURL('news_thumbnail').$value['thumbnail']?>"  width="100"  class="bordor" />
										</a>
									<?php }?>
								</td>
                ...
                <td class="center"><?=$this->xFunction->checkICON($value['sticky'])?></td>
								<td class="center"><?=$this->xFunction->checkSTATUS($value['status'])?>
							  ...
							  <td class="center">
									<a href="<?=$this->baseurl->backend->module->news->view.$value['id']?>" class="btn btn-info btn-xs btn-action" title="<?=$this->lang->title->detail?>">
										<i class="ace-icon fa fa-file-text-o" aria-hidden="true"></i>
									</a>
									<a href="<?=$this->baseurl->backend->module->news->manage.$value['id']?>" class="btn btn-primary btn-xs btn-action" title="<?=$this->lang->title->edit?>">
