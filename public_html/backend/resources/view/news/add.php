<?php
$datetime_start = date('d/m/Y') . ' 08:30:00';
$datetime_end = date('d/m/Y') . ' 16:30:00';
?>
          ...
          <div class="col-md-6">
            <form id="frm" name="frm" class="form-horizontal" role="form" method="post" action="" data-parsley-validate="" enctype="multipart/form-data">
                ...
                <div class="profile-user-info profile-user-info-striped">
                  <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                      <span>
                        <input type="text" id="news_title" name="news_title" value="" class="form-control" required="" />
                      </span>
                    </div>
                  </div>
                  <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                      <span>
                        ...
                        <?php if (!empty($getData['thumbnail'])) { ?>
                          <div class="thumb_del">
                            <a href="<?= $this->ReserveMediaURL('news_thumbnail') . $getData['thumbnail'] ?>" data-lity>
                              <img src="<?= $this->ReserveMediaURL('news_thumbnail') . $getData['thumbnail'] ?>" width="200" />
                            </a><br />
                            <a class="confirm-thumbnail-delete" id="delete_thumbnail_loading" href="javascript:void(0)"><i class="ace-icon fa fa-trash"></i> <?= $this->lang->button->delete ?></a>
                          </div>
                        <?php } ?>
                  ...
                  <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                      <span>
                        <textarea id="news_overview" name="news_overview" cols="50" rows="2" class="input_textarea"></textarea>
                      </span>
                    </div>
                  </div>
                  <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                      <span>
                        <textarea id="news_description" name="news_description" cols="50" class="form-control" rows="4"></textarea>
                      </span>
                    </div>
                  </div>
                  <div class="profile-info-row">
                  ...
                  <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                      <span>
                        <input type="text" id="news_youtube" name="news_youtube" class="form-control" />
                      </span>
                    </div>
                  </div>
                  <?php if ($this->checkUID('level') == 9) { ?>
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <input type="checkbox" class="switcher" id="news_sticky" name="news_sticky" value="1">
                        </span>
                      </div>
                    </div>
                  <?php  } ?>
                  ...
                  <?php if ($this->checkUID('level') == 9) { ?>
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <input type="checkbox" class="switcher" id="news_status" name="news_status" value="1">
                        </span>
                      </div>
                    </div>
                  <?php  } ?>
              ...
              <div class="clearfix form-actions">
                <a href="<?= $this->baseurl->backend->module->news->list; ?>" id="backtolist" class="btn pull-left"><i class="fa fa-chevron-left" aria-hidden="true"></i> <?= $this->lang->button->back ?></a>
      ...
      <form id="efrm" name="efrm" class="form-horizontal" role="form" method="post" action="" data-parsley-validate="" enctype="multipart/form-data">
        <div id="modal-wizard-container">
          <div class="modal-header">
            <h3><?= $this->lang->page->news_thumbnail ?></h3>
          </div>
    ...
    <div class="modal-content">
      <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="<?= $this->baseurl->backend->process ?>">
        ...
        <div class="modal-footer wizard-actions">
          ...
          <input type="hidden" id="module" name="module" value="News" />
          <input type="hidden" id="action" name="action" value="upload-reserve-gallery" />
          ...
          <a href="#modal-images-manage" onclick="load_reserve_manage_gallery(); click_close_modal('close-modal');" class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-backdrop="static" data-keyboard="false"><i class="ace-icon fa fa-pencil-square-o"></i><?= $this->lang->action->edit ?></a>
          <div class="clearfix"></div>
        </div>
      </form>
    </div><!--modal-content-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="sfrm" name="sfrm" class="form-horizontal" role="form" method="post" action="" data-parsley-validate="">
        <div id="modal-wizard-container">
          <div class="modal-header">
            <h3><?= $this->lang->page->news_manage_gallery ?></h3>
          </div>
          <div class="modal-body step-content">
    ...
    <div class="modal-content">
      <form method="post" name="multiple_upload_files" id="multiple_upload_files" enctype="multipart/form-data" action="<?= $this->baseurl->backend->process ?>">
        ...
        <div class="modal-footer wizard-actions">
          ...
          <input type="hidden" id="module" name="module" value="News" />
          <input type="hidden" id="action" name="action" value="upload-reserve-attachment" />
          <button class="btn btn-sm pull-left" data-dismiss="modal" id="fclose-modal">
            <i class="ace-icon fa fa-times"></i> <?= $this->lang->button->close ?>
          </button>
          <a href="#modal-files-manage" onclick="load_reserve_manage_attachment(); click_close_modal('fclose-modal');" class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-backdrop="static" data-keyboard="false"><i class="ace-icon fa fa-pencil-square-o"></i><?= $this->lang->action->edit ?></a>
          <div class="clearfix"></div>
        </div>
      </form>
    </div><!--modal-content-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="images_frm" name="images_frm" class="form-horizontal" role="form" method="post" action="" onsubmit="return edit_images_title()">
        <div id="modal-wizard-container">
          <div class="modal-header">
            <h3><?= $this->lang->page->news_images_data ?></h3>
          </div>
          <div class="modal-body step-content">
...
<script type="text/javascript">
  ...
  function load_reserve_manage_gallery() {
  ...
  function load_reserve_attachment() {
    ...
    $.ajax({
      ...
      data: {
        module: 'News',
        load: 'load-reserve-attachment'
      },
      success: function(data, textStatus, jqXHR) {
        if (textStatus == 'success') {
          $("#content_attachment").html(data);
        }
      },
      error: function(jqXHR, textStatus, errorThrown) {
        alert('Error!');
  ...
  function load_reserve_manage_attachment() {
  ...
  $(document).ready(function() {
    load_reserve_gallery();
    load_reserve_manage_gallery();
    load_reserve_attachment();
    load_reserve_manage_attachment();
    load_news_images();
    /* Upload Images & Files */
  ...
  $(function() {
    ...
    $('#efrm').submit(function() {
      ...
      formData.append('action', 'save-reserve-thumbnail');
    ...
    $("#select_items").on('click', function() {
      ...
      if (strChoices.length > 0) {
        ...
        bootbox.confirm({
          ...
          buttons: {
            confirm: {
              label: "<?= $this->lang->button->confirm ?>",
              className: "btn-primary btn-sm",
            },
            cancel: {
              label: "<?= $this->lang->button->cancel ?>",
  ...
  $(function() {
    $('#frm').parsley().on('field:validated', function() {
      ...
      .on('form:submit', function() {
        ...
        <?php if ($this->checkUID('level') == 9) { ?>
          var sticky;
          var status;
          if ($("#news_sticky").is(':checked')) {
            sticky = 1;
          } else {
            sticky = 0;
          }
          if ($("#news_status").is(':checked')) {
            status = 1;
          } else {
            status = 0;
          }
        ...
        var formData = new FormData();
        formData.append('module', 'News');
        formData.append('action', 'create-news');
    ...
    $('#sfrm').parsley().on('field:validated', function() {
      ...
      .on('form:submit', function() {
        ...
        formData.append('module', 'News');
        formData.append('action', 'update-reserve-gallery-title');
    ...
    $('#zfrm').parsley().on('field:validated', function() {
      ...
      .on('form:submit', function() {
        ...
        formData.append('module', 'News');
        formData.append('action', 'update-reserve-files-title');
        formData.append('items_title', title);
    ...
    $('.thumb_del').on("click", ".confirm-thumbnail-delete", function() {
      $("#delete_thumbnail_loading").html('<i class="ace-icon fa fa-spinner fa-spin bigger-130"></i>');
      bootbox.confirm({
        message: "<?= $this->lang->alert->confirm->reserve_images_delete ?> ?",
        buttons: {
          confirm: {
            label: "<?= $this->lang->button->confirm ?>",
            className: "btn-primary btn-sm",
          ...
          if (result) {
            $.ajax({
              ...
              success: function(data, textStatus, jqXHR) {
                ...
                $("#delete_thumbnail_loading").html('<i class="ace-icon fa fa-trash"></i> <?= $this->lang->button->delete ?>');
              },
              error: function(jqXHR, textStatus, errorThrown) {
                alert('Error!');
                window.location.reload();
