...
<script type="text/javascript">
  ...
  function load_reserve_gallery(){
    ...
    $.ajax({
     ...
     type: "POST",
     data : {module:'News',load:'reserve-load-gallery'},
     success: function(data, textStatus, jqXHR){
  ...
  function load_reserve_manage_gallery(){
    ...
    $.ajax({
     url : "<?=$this->baseurl->backend->loading?>",
     type: "POST",
     data : {module:'News',load:'reserve-manage-gallery'},
     success: function(data, textStatus, jqXHR){
  ...
  function load_reserve_attachment(){
    ...
    $.ajax({
     url : "<?=$this->baseurl->backend->loading?>",
     type: "POST",
     data : {module:'News',load:'load-reserve-attachment'},
     success: function(data, textStatus, jqXHR){
  ...
  function load_reserve_manage_attachment(){
    ...
    $.ajax({
     url : "<?=$this->baseurl->backend->loading?>",
     type: "POST",
     data : {module:'News',load:'manage-reserve-attachment'},
     success: function(data, textStatus, jqXHR){
            ...
            callback: function(result)
            {
              if(result) {
                 $.ajax({
                  url : "<?=$this->baseurl->backend->process?>",
                  type: "POST",
                  data : {module:'News',action:'select-reserve-gallery-del',items_list:numbers},
                  success: function(data, textStatus, jqXHR)
                  {
            ...
            callback: function(result)
            {
              if(result) {
                 $.ajax({
                  url : "<?=$this->baseurl->backend->process?>",
                  type: "POST",
                  data : {module:'News',action:'select-reserve-files-del',items_list:numbers},
                  success: function(data, textStatus, jqXHR)
                  {
        ...
        callback: function(result) {
          if(result) {
             $.ajax({
              url : "<?=$this->baseurl->backend->process?>",
              type: "POST",
              data : {module:'News',action:'reserve-thumbnail-delete'},
              success: function(data, textStatus, jqXHR)
              {
                if(textStatus=='success'){$( "#xmessage" ).html(data);}
