  ...
  <div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li class="active"><?=$this->lang->page->slide_edit?></li>
        </ul>
    </div><!-- /.breadcrumbs -->
    <!-- /plugins -->
    ...
    <div class="page-content">
      <div class="col-sm-10 col-sm-offset-1">
        <div class="page-header">
         <h1><?=$this->lang->page->slide_edit?></h1>
        </div><!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
                ...
                <div class="profile-user-info profile-user-info-striped">
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <?php if(!empty($getData['img_thumb'])){ $images1_empty=0; ?>
                            <div class="thumb_del">
                              <a href="<?=$this->mediaURL('banner').$getData['img_thumb']?>" data-lity>
                                <img src="<?=$this->mediaURL('banner').$getData['img_thumb']?>" width="200" />
                              </a><br />
                              <label class="label_del"><input id="del_images1" name="del_images1" type="checkbox" value="1" /> <?=$this->lang->label->delete?></label>
                            </div>
                          <?php }else{ echo '<input id="del_images1" name="del_images1" type="hidden" value="0" />'; $images1_empty=1; }?>
                          <div id="myImg"></div>
                          <label class="ace-file-input">
                          	  <input type="file" name="images1" id="images1" multiple="" autocomplete="off" <?php if($images1_empty==1){?>required=""<?php }?>>
                          ...
                          <?=$this->xFunction->placeholder('slide_banner','span')?>
                        </span>
                      </div>
                  </div>
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <?php if(!empty($getData['mb_img_thumb'])){ $images2_empty=0;?>
                            <div class="thumb_del">
                              <a href="<?=$this->mediaURL('banner').$getData['mb_img_thumb']?>" data-lity>
                                <img src="<?=$this->mediaURL('banner').$getData['mb_img_thumb']?>" width="200" />
                              </a><br />
                              <label class="label_del"><input id="del_images2" name="del_images2" type="checkbox" value="1" /> <?=$this->lang->label->delete?></label>
                            </div>
                          <?php }else{ echo '<input id="del_images2" name="del_images2" type="hidden" value="0" />';  $images2_empty=1; }?>
                          <div id="myImg2"></div>
                          <label class="ace-file-input">
                              <input type="file" name="images2" id="images2" multiple="" autocomplete="off" <?php if($images2_empty==1){?>required=""<?php }?>>
                              <span class="ace-file-container" data-title="<?=$this->lang->label->select?>">
                                <span class="ace-file-name" data-title="...">
                                  <i class="ace-icon fa fa-upload"></i>
                                </span>
                          ...
                          <?=$this->xFunction->placeholder('slide_mbbanner','span')?>
                        </span>
                      </div>
                  </div>
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <input  type="text" id="title" name="title" value="<?=$this->xFunction->htmlspec($getData['title'])?>" class="form-control" required="" />
                        </span>
                      </div>
                  </div>
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <textarea id="description" name="description" cols="50" class="form-control" rows="4" ><?=$this->xFunction->htmlspec($getData['description'])?></textarea>
                        </span>
                      </div>
                  </div>
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <input  type="text" id="link_url" name="link_url" value="<?=urldecode($getData['link_url'])?>" class="form-control" <?=$this->xFunction->placeholder('link_url')?> />
                        </span>
                      </div>
                  </div>
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <input  type="number" id="sort_order" name="sort_order" value="<?=$getData['sort_order']?>" onclick="this.select()" required="" />
                  ...
                  <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span>
                          <input type="checkbox" id="status" name="status" class="switcher" <?php if($getData['status']=='1'){ echo 'checked="checked"';}?> value="1">
                        </span>
                      </div>
                  </div>
              ...
              <div class="clearfix form-actions">
                ...
                <input id="id" name="id" type="hidden" value="<?=$getData['id']?>" />
...
<script type="text/javascript">
  ...
  $(function () {
	  ...
	  .on('form:submit', function() {
        ...
        formData.append('del_images1',$("input[name=del_images1]:checked").val());
				formData.append('images1', $('input[name=images1]')[0].files[0]);
        formData.append('del_images2',$("input[name=del_images2]:checked").val());
